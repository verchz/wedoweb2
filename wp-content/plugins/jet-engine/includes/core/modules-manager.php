...
if ( ! class_exists( 'Jet_Engine_Modules' ) ) {
	...
	class Jet_Engine_Modules {
		...
		public function save_modules() {
			...
			$reload_modules = array( 'booking-forms', 'profile-builder', 'maps-listings', 'data-stores' );
		...
		public function preload_modules() {
			...
			$all_modules = apply_filters( 'jet-engine/available-modules', array(
				...
				'Jet_Engine_Module_Maps_Listings'      => $base_path . 'maps-listings/maps-listings.php',
				'Jet_Engine_Module_Dynamic_Visibility' => $base_path . 'dynamic-visibility/dynamic-visibility.php',
				'Jet_Engine_Module_Data_Stores'        => $base_path . 'data-stores/data-stores.php',
			) );
