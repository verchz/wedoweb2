...
class Render_Links {
	...
	public function __construct() {
		...
		add_filter( 'jet-engine/listings/macros-list', array( $this, 'add_count_macros' ) );
	 ...
	 */
	public function add_count_macros( $macros ) {
		$macros['store_count'] = array( $this, 'store_count' );
		return $macros;
	}
